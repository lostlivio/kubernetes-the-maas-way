...
The commands in this lab must be run the controller instance
...
Retrieve the `kubernetes-the-maas-way` static IP address:
...
```
curl --cacert ca.pem https://${CONTROLLER_IP_ADDRESS}:6443/version
```
